...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFMODEventProperty(EFMODEventProperty_StaticEnum, TEXT("/Script/FMODStudio"), TEXT("EFMODEventProperty"), false, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(UFMODAudioComponent, 3031643702);
	void AFMODAmbientSound::StaticRegisterNativesAFMODAmbientSound()
	{
	}
	IMPLEMENT_CLASS(AFMODAmbientSound, 325713637);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFMODSpeakerMode(EFMODSpeakerMode_StaticEnum, TEXT("/Script/FMODStudio"), TEXT("EFMODSpeakerMode"), false, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(UFMODSnapshotReverb, 1481680408);
...
// Cross Module References
	...
	UEnum* Z_Construct_UEnum_FMODStudio_EFMODEventProperty()
	{
		...
		if (!ReturnEnum)
		{
			...
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EFMODEventProperty::ChannelPriority")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EFMODEventProperty::ScheduleDelay")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EFMODEventProperty::ScheduleLookahead")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EFMODEventProperty::MinimumDistance")), 3));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EFMODEventProperty::MaximumDistance")), 4));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EFMODEventProperty::Count")), 5));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EFMODEventProperty::EFMODEventProperty_MAX")), 6));
	...
	uint32 Get_Z_Construct_UEnum_FMODStudio_EFMODEventProperty_CRC() { return 4167789062U; }
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				MetaData->SetValue(NewProp_AttenuationOverrides, TEXT("ToolTip"), TEXT("If bOverrideSettings is true, the attenuation properties to use for sounds generated by this component (FMOD only uses the Occlusion part) //struct FAttenuationSettings AttenuationOverrides;"));
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UEnum* Z_Construct_UEnum_FMODStudio_EFMODSpeakerMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			TArray<TPair<FName, int64>> EnumNames;
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EFMODSpeakerMode::Stereo")), 0));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EFMODSpeakerMode::Surround_5_1")), 1));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EFMODSpeakerMode::Surround_7_1")), 2));
			EnumNames.Add(TPairInitializer<FName, int64>(FName(TEXT("EFMODSpeakerMode::EFMODSpeakerMode_MAX")), 3));
			ReturnEnum->SetEnums(EnumNames, UEnum::ECppForm::Namespaced);
	...
	uint32 Get_Z_Construct_UEnum_FMODStudio_EFMODSpeakerMode_CRC() { return 2875109743U; }
